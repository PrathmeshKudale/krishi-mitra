...
st.info("👉 [Click here to login](https://krishi-mitra-pltp.onrender.com)")
# =============================================================================
    ...
    if page == get_text('home', selected_lang):
        ...
        with col1:
            ...
            <div class="feature-card">
                ...
                <div class="feature-title">{get_text('ai_assistant', selected_lang).split(' ')[1]}</div>
                <div class="feature-desc">{get_text('ask_question', selected_lang)}</div>
            </div>
        ...
        with col2:
            ...
            <div class="feature-card">
                <div class="feature-icon">📸</div>
                <div class="feature-title">{get_text('crop_diagnosis', selected_lang).split(' ')[1]}</div>
                <div class="feature-desc">{get_text('upload_image', selected_lang)}</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col3:
            ...
            <div class="feature-card">
                <div class="feature-icon">👥</div>
                <div class="feature-title">{get_text('community', selected_lang).split(' ')[1]}</div>
                <div class="feature-desc">{get_text('share_experience', selected_lang)}</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        <div class="main-footer">
            <div class="feature-icon">🌾</div>
            <div style="font-size: 1.25rem; font-weight: bold; color: var(--text-color); margin-bottom: 0.5rem;">
                Krishi Mitra
            </div>
            <div style="font-size: 1rem; color: var(--secondary-color); margin-bottom: 0.5rem;">
                {ft['tagline']}
            </div>
            <div style="font-size: 0.9rem; color: #555; margin-bottom: 1rem;">
                {ft['made_with_love']}
            </div>
            <div style="font-size: 0.8rem; color: #888; border-top: 1px solid #C8E6C9; padding-top: 1rem;">
                {ft['copyright']}
            </div>
        </div>
        """, unsafe_allow_html=True)
                ...
                for post in posts:
                    with st.container():
                        ...
                        <div class="feature-card">
                            ...
                            <p class="feature-desc">{post['content']}</p>
                            <small style="color: #666;">🕐 {format_datetime(post['created_at'])}</small>
                        </div>
                        """, unsafe_allow_html=True)
